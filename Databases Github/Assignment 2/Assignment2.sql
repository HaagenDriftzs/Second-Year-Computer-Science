...
(
	...
	emailAdr             VARCHAR2(30) NOT NULL  CONSTRAINT  Email_@ CHECK (EMAIL LIKE '%@%'),
CONSTRAINT  Client_PK PRIMARY KEY (clientID),CONSTRAINT  Client_PK UNIQUE (emailAdr)
);
/*
...
(
	designerID           NUMBER(6) NOT NULL  CONSTRAINT  Email_@_1432585314 CHECK (EMAIL LIKE '%@%'),
	fullName             VARCHAR2(50) NOT NULL ,
	emailAdr             VARCHAR2(30) NULL ,
	dRateofPay           NUMBER(4,2) NULL  CONSTRAINT  DesignerRateOfPay CHECK (DESIGNERROP <= 75.99),
CONSTRAINT  Designer_PK PRIMARY KEY (designerID),CONSTRAINT  Designer_PK UNIQUE (emailAdr)
);
/*
...
(
	...
	specCommission       NUMBER(7,2) NULL  CONSTRAINT  SpecificationComission CHECK (SPECCOMISSION <= 16000),
	clientID             NUMBER(6) NULL ,
	designerID           NUMBER(6) NULL ,
	designHrsWorked      NUMBER(4) NULL  CONSTRAINT  Hours_worked____150 CHECK (DESIGNHOURSWORKED <= 150),
	specDate             DATE NULL ,
...
There is also the addition of prodCat being primary key.
*/
CREATE TABLE ProdType
(
	prodCat              CHAR(1) NOT NULL  CONSTRAINT  Product_Catagory_Le_1924227657 CHECK (PRODUCTCATAGORY IN (G,L,C,S,X)),
...
(
	...
	prodUnitPrice        NUMBER(4,2) NULL  CONSTRAINT  ProductUnitPrice CHECK (PRODUCTPRICE BETWEEN 5.00 AND 45.50),
	prodQtyInStock       NUMBER(3) NULL ,
	prodCat              CHAR(1) NOT NULL  CONSTRAINT  Product_Catagory_Le_1938736065 CHECK (PRODUCTCATAGORY IN (G,L,C,S,X)),
...
(
	...
	prodCat              CHAR(1) NOT NULL  CONSTRAINT  Product_Catagory_Le_1890605374 CHECK (PRODUCTCATAGORY IN (G,L,C,S,X)),
